...
% -------------------------------------------------------------------------
defaultFolder = 'D:\proj_HFD-sociability\DATASET';
outputFolder = 'D:\proj_HFD-sociability\RESULTS';
...
for i = 1:length(sliceArray)
    ...
    new_T = sliceArray(i).quantifyDots(annotationVolume,channel,"none",40, 8);
    T = [T; new_T];
end
